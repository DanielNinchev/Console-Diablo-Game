...
namespace ConsoleDiablo2.DataModels.Items.Weapons
{
    public class Sword : Weapon
    {
        ...
        {
            this.Size = this.random.Next(WeaponConstants.SwordMinSize, WeaponConstants.SwordMaxSize);
            this.SellValue = WeaponConstants.SwordMaxSellValue * this.Size / (int)itemType;
            ...
            switch (itemType)
            {
                case ItemClass.Ordinary:
                    this.Damage.Value = this.random.Next(WeaponConstants.SwordMinDamageBonus, WeaponConstants.SwordMaxDamageBonus);
                    break;

                case ItemClass.Superior:
                    this.DamageToMonsterType = (Bonus)Activator.CreateInstance(type);

                    this.Damage.Value = this.random.Next(WeaponConstants.SwordMaxDamageBonus, WeaponConstants.SuperiorSwordMaxDamageBonus);
                ...
                case ItemClass.Magic:
                    ...
                    this.Damage.Value = this.random.Next(WeaponConstants.SuperiorSwordMaxDamageBonus, WeaponConstants.MagicSwordMaxDamageBonus);
                    ...
                    this.SkillBonus.Description = String.Concat(this.SkillBonus.Value.ToString(),
                        BonusConstants.To, BonusConstants.SwordSkillBonuses[random.Next(0, BonusConstants.SwordSkillBonuses.Count - 1)]);
                ...
                case ItemClass.Rare:
                    ...
                    this.Damage.Value = this.random.Next(WeaponConstants.MagicSwordMaxDamageBonus, WeaponConstants.RareSwordMaxDamageBonus);
                    ...
                    this.ChanceOfCriticalHit.Value = random.Next(WeaponConstants.SwordMinChanceOfCriticalHit, WeaponConstants.SwordMaxChanceOfCriticalHit);
                ...
                case ItemClass.Legendary:
                    ...
                    this.Damage.Value = this.random.Next(WeaponConstants.RareSwordMaxDamageBonus, WeaponConstants.LegendarySwordMaxDamageBonus);
            ...
            this.Accuracy.Value = this.random.Next(WeaponConstants.SwordMinAccuracy, WeaponConstants.WeaponMaxAccuracy);
            ...
            this.Name = String.Concat(itemType, " ", typeof(Sword).Name, ItemConstants.weaponNames[random.Next(0, ItemConstants.weaponNames.Count - 1)]);
