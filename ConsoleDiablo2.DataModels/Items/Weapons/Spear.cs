...
namespace ConsoleDiablo2.DataModels.Items.Weapons
{
    public class Spear : Weapon
    {
        ...
        {
            this.Size = this.random.Next(WeaponConstants.SpearMinSize, WeaponConstants.SpearMaxSize);
            this.SellValue = WeaponConstants.SpearMaxSellValue * this.Size / (int)itemType;
            ...
            switch (itemType)
            {
                case ItemClass.Ordinary:
                    this.Damage.Value = this.random.Next(WeaponConstants.SpearMinDamageBonus, WeaponConstants.SpearMaxDamageBonus);
                    break;

                case ItemClass.Superior:
                    this.DamageToMonsterType = (Bonus)Activator.CreateInstance(type);

                    this.Damage.Value = this.random.Next(WeaponConstants.SpearMaxDamageBonus, WeaponConstants.SuperiorSpearMaxDamageBonus);
                ...
                case ItemClass.Magic:
                    ...
                    this.Damage.Value = this.random.Next(WeaponConstants.SuperiorSpearMaxDamageBonus, WeaponConstants.MagicSpearMaxDamageBonus);
                    ...
                    this.SkillBonus.Description = String.Concat(this.SkillBonus.Value.ToString(),
                        BonusConstants.To, BonusConstants.SpearSkillBonuses[random.Next(0, BonusConstants.SpearSkillBonuses.Count - 1)]);
                ...
                case ItemClass.Rare:
                    ...
                    this.Damage.Value = this.random.Next(WeaponConstants.MagicSpearMaxDamageBonus, WeaponConstants.RareSpearMaxDamageBonus);
                    ...
                    this.ChanceOfCriticalHit.Value = random.Next(WeaponConstants.SpearMinChanceOfCriticalHit, WeaponConstants.SpearMaxChanceOfCriticalHit);
                ...
                case ItemClass.Legendary:
                    ...
                    this.Damage.Value = this.random.Next(WeaponConstants.RareSpearMaxDamageBonus, WeaponConstants.LegendarySpearMaxDamageBonus);
            ...
            this.Accuracy.Value = this.random.Next(WeaponConstants.SpearMinAccuracy, WeaponConstants.WeaponMaxAccuracy);
            ...
            this.Name = String.Concat(itemType, " ", typeof(Spear).Name, ItemConstants.weaponNames[random.Next(0, ItemConstants.weaponNames.Count - 1)]);
