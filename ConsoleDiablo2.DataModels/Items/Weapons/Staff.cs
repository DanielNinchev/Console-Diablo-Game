...
namespace ConsoleDiablo2.DataModels.Items.Weapons
{
    public class Staff : Weapon
    {
        ...
        {
            this.Size = this.random.Next(WeaponConstants.StaffMinSize, WeaponConstants.StaffMaxSize);
            this.SellValue = WeaponConstants.StaffMaxSellValue * this.Size / (int)itemType;
            ...
            switch (itemType)
            {
                case ItemClass.Ordinary:
                    this.Damage.Value = this.random.Next(WeaponConstants.StaffMinDamageBonus, WeaponConstants.StaffMaxDamageBonus);
                    break;

                case ItemClass.Superior:
                    this.DamageToMonsterType = (Bonus)Activator.CreateInstance(type);

                    this.Damage.Value = this.random.Next(WeaponConstants.StaffMaxDamageBonus, WeaponConstants.SuperiorStaffMaxDamageBonus);
                ...
                case ItemClass.Magic:
                    ...
                    this.Damage.Value = this.random.Next(WeaponConstants.SuperiorStaffMaxDamageBonus, WeaponConstants.MagicStaffMaxDamageBonus);
                    ...
                    this.SkillBonus.Description = String.Concat(this.SkillBonus.Value.ToString(),
                        BonusConstants.To, BonusConstants.StaffSkillBonuses[random.Next(0, BonusConstants.StaffSkillBonuses.Count - 1)]);
                ...
                case ItemClass.Rare:
                    ...
                    this.Damage.Value = this.random.Next(WeaponConstants.MagicStaffMaxDamageBonus, WeaponConstants.RareStaffMaxDamageBonus);
                    ...
                    this.ChanceOfCriticalHit.Value = random.Next(WeaponConstants.StaffMinChanceOfCriticalHit, WeaponConstants.StaffMaxChanceOfCriticalHit);
                ...
                case ItemClass.Legendary:
                    ...
                    this.Damage.Value = this.random.Next(WeaponConstants.RareStaffMaxDamageBonus, WeaponConstants.LegendaryStaffMaxDamageBonus);
            ...
            this.Accuracy.Value = this.random.Next(WeaponConstants.StaffMinAccuracy, WeaponConstants.WeaponMaxAccuracy);
            ...
            this.Name = String.Concat(itemType, " ", typeof(Staff).Name, ItemConstants.weaponNames[random.Next(0, ItemConstants.weaponNames.Count - 1)]);
