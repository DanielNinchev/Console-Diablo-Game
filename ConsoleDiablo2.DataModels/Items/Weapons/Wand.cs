...
namespace ConsoleDiablo2.DataModels.Items.Weapons
{
    public class Wand : Weapon
    {
        ...
        {
            this.Size = this.random.Next(WeaponConstants.WandMinSize, WeaponConstants.WandMaxSize);
            this.SellValue = WeaponConstants.WandMaxSellValue * this.Size / (int)itemType;
            ...
            switch (itemType)
            {
                case ItemClass.Ordinary:
                    this.Damage.Value = this.random.Next(WeaponConstants.WandMinDamageBonus, WeaponConstants.WandMaxDamageBonus);
                    break;

                case ItemClass.Superior:
                    this.DamageToMonsterType = (Bonus)Activator.CreateInstance(type);

                    this.Damage.Value = this.random.Next(WeaponConstants.WandMaxDamageBonus, WeaponConstants.SuperiorWandMaxDamageBonus);
                ...
                case ItemClass.Magic:
                    ...
                    this.Damage.Value = this.random.Next(WeaponConstants.SuperiorWandMaxDamageBonus, WeaponConstants.MagicWandMaxDamageBonus);
                    ...
                    this.SkillBonus.Description = String.Concat(this.SkillBonus.Value.ToString(),
                        BonusConstants.To, BonusConstants.WandSkillBonuses[random.Next(0, BonusConstants.WandSkillBonuses.Count - 1)]);
                ...
                case ItemClass.Rare:
                    ...
                    this.Damage.Value = this.random.Next(WeaponConstants.MagicWandMaxDamageBonus, WeaponConstants.RareWandMaxDamageBonus);
                    ...
                    this.ChanceOfCriticalHit.Value = random.Next(WeaponConstants.WandMinChanceOfCriticalHit, WeaponConstants.WandMaxChanceOfCriticalHit);
                ...
                case ItemClass.Legendary:
                    ...
                    this.Damage.Value = this.random.Next(WeaponConstants.RareWandMaxDamageBonus, WeaponConstants.LegendaryWandMaxDamageBonus);
            ...
            this.Accuracy.Value = this.random.Next(WeaponConstants.WandMinAccuracy, WeaponConstants.WeaponMaxAccuracy);
            ...
            this.Name = String.Concat(itemType, " ", typeof(Wand).Name, ItemConstants.weaponNames[random.Next(0, ItemConstants.weaponNames.Count - 1)]);
